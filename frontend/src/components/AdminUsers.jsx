...
function AdminUsers() {
  ...
  // ✅ Fetch all users (cookies are sent automatically)
  ...
  const handleUpdateClick = async (userId) => {
    ...
    try {
      await axiosConfig.put(`/api/admin/roles/users/${userId}/role`, { role: newRole }, {
  ...
  return (
    <div className="container mt-4">
          ...
          <div className="row g-2">
            <div className="col-md-3">
              <input type="text" name="username" value={newUser.username}
                onChange={handleNewUserChange} placeholder="Username" required className="form-control" />
            </div>
            <div className="col-md-3">
              <input type="email" name="email" value={newUser.email}
                onChange={handleNewUserChange} placeholder="Email" required className="form-control" />
            </div>
            <div className="col-md-3">
              <input type="password" name="password" value={newUser.password}
                onChange={handleNewUserChange} placeholder="Password" required className="form-control" />
            </div>
            <div className="col-md-2">
              <select name="role" value={newUser.role} onChange={handleNewUserChange} className="form-select">
      ...
      <input type="text" placeholder="Search by username or email..."
        className="form-control w-50 my-3" value={searchTerm} onChange={handleSearch} />
